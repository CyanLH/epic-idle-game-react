...
export default function LoginPage() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gameBg overflow-hidden font-nunito">
      {/* Background animated elements */}
      <div className="absolute inset-0 bg-gradient-to-tr from-purple-900 via-pink-800 to-indigo-900 opacity-80" />
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-30 mix-blend-overlay animate-pulse-glow" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-10 max-w-lg w-full">
        ...
        <div className="bg-gamePanel/20 backdrop-blur-md p-8 rounded-3xl shadow-[0_0_40px_rgba(255,105,180,0.3)] border-2 border-pink-500/30 text-center w-full">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" width="28" height="28" xmlns="http://www.w3.org/2000/svg" className="z-10 relative">
            ...
            <span className="z-10 relative">Google 계정으로 게임 시작</span>
          </button>
        </div>
      </div>
    </div>
